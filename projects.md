...
**Click below for detailed research:**
...
Contributed to the development of an **interactive web-based visualization system** for oil well data. 
- Enhancing web page design and user interface, implementing interactive features using Leaflet.js for geospatial data visualization. Working on the integration of MySQL database with the web interface to enable real-time data display.
- Demonstrated proficiency in web development, particularly in creating user-friendly interfaces for complex data visualization on Linux systems.
- Gained valuable experience in geospatial data handling, database integration, and technical documentation while working in a Linux environment.
**Click below for detailed web page:**
[![My Image](https://Cassandra265.github.io/images/projects/web.png)](https://Cassandra265.github.io/file/well_location.html)
...
**Click below for detailed chatbot dispaly:**
